...
ParticleScope=[29,-117,6.5;25,-121,2.5];VScope=[3,3,3;-3,-3,-3];
...
%% 4 输出结果
[~,bestYL]=CalculateYingL(gbest(1,1),gbest(1,2),gbest(1,3));
plot(DieF);
...
disp(['最优赤纬角 chi 是：',num2str(gbest(1,3))]);
...
disp(['最优赤纬角 chi 是：',num2str(position(pindex,3))]);
disp('两影长比值');
bestYL./TrueYL
disp('影长：');
bestYL
